...
## Chapter6 Game Perspectives 游戏透视 
...
![image-20220518205058926](PixelLogic.assets/image-20220518205058926.png)，不不不不不不不不不不不不不不不不不不不不不不不不不不不不不不不不女不不过或付若过拖若上给
...
![image-20220529185856968](PixelLogic.assets/image-20220529185856968.png)

### 从粗糙到整洁

![image-20220529190034550](PixelLogic.assets/image-20220529190034550.png)

由于像素艺术的特性，所以很容易成稿和草图有很大的差异。

![image-20220529190746563](PixelLogic.assets/image-20220529190746563.png)
...
![image-20220529190855887](PixelLogic.assets/image-20220529190855887.png)

### 更整洁的形状

像素clump聚集在一起，我们叫做shapes，或者clusters, clumps,chunks,blocks

### 迪士尼的“懒线条”

![image-20220530232459238](PixelLogic.assets/image-20220530232459238.png)

有些线条不仅仅是线条本身更关注与形状和阴影。他们并不描述什么，而是当你追踪一部分线条的共识的结构。



在你考虑布置光影时候，你不会不加思考，那么整洁的shading对于无论精细粗浅的作品都是重要的。

![image-20220530232937699](PixelLogic.assets/image-20220530232937699.png)

### 多个版本，头脑风暴

为了尽善尽美，可以重复上述步骤，对于一些地方进行微调，从而得到不同的版本。然后挑选最喜欢的一种。

有时候未必是“微调”，整体的姿态，光照都可以改变。
...
![image-20220530233950146](PixelLogic.assets/image-20220530233950146.png)

#### 缩放

#### 调整色彩对比

![image-20220530234451554](PixelLogic.assets/image-20220530234451554.png)
...
后处理并不是前面几章的要点那么立竿见影，但是好的后处理可以让你的像素画看上去完全不同。同时运用到前面讲的所有内容。

## Chapter8 Subpixeling 亚像素

### 亚像素定义

好像比一像素还小

![image-20220531001235496](PixelLogic.assets/image-20220531001235496.png)